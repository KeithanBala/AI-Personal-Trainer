...
Exercises = ['Shoulder Press', 'Squat', 'Bicep Curl', 'Tricep Extension', 'Jumping Jack', 'Skip Rope', 'Lat-pulldown', 'Pull Up', 'Chin Up']

# define the window layout
layout = [[sg.Text('Pose Estimation Workout', size=(40, 1), justification='center', font='Helvetica 20')],
          [sg.Listbox(list(Exercises), size=(20,4), pad=((250, 0), 3), enable_events=False, key='_LIST_')],
...
window = sg.Window('Demo Application - OpenCV Integration', layout, location=(0, 400))
